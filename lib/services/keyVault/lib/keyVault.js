 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
KeyVaultClient.prototype.createCertificate = function (vaultBaseUrl, certificateName, certificatePolicy, options, callback) {
  return this._internalClient.createCertificate(vaultBaseUrl, certificateName, certificatePolicy, options, callback);
};
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
KeyVaultClient.prototype.importCertificate = function (vaultBaseUrl, certificateName, base64EncodedCertificate, password, certificatePolicy, options, callback) {
  return this._internalClient.importCertificate(vaultBaseUrl, certificateName, base64EncodedCertificate, password, certificatePolicy, options, callback);
};
